...
class $AssetsLottieGen {
  ...
  LottieGenImage get fail => const LottieGenImage(
      'assets/lottie/fail.json');

  /// File path: assets/lottie/scuess.json
  LottieGenImage get scuess =>
      const LottieGenImage(
          'assets/lottie/scuess.json');

  /// File path: assets/lottie/waiting.json
  LottieGenImage get waiting =>
      const LottieGenImage(
...
class $AssetsImagesPngGen {
  ...
  /// File path: assets/images/png/chat _logo.png
  AssetGenImage get chatLogo =>
      const AssetGenImage(
          'assets/images/png/chat _logo.png');

  /// List of all assets
  List<AssetGenImage> get values => [chatLogo];
}
